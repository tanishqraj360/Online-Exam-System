...
def login():
    ...
    if request.method == 'POST':
        ...
        cur.execute("CREATE TABLE if not exists `students` (`ID` int(125) NOT NULL,  `Name` varchar(65) NOT NULL,`Email` varchar(85) NOT NULL,`Password` varchar(85) NOT NULL,`Role` varchar(65) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;")
        cur.execute("INSERT INTO `students` (`ID`, `Name`, `Email`, `Password`, `Role`) VALUES (1,'Admin','admin@gmail.com','admin@123','ADMIN');")
